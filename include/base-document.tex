...
% tout ce qui est apres le % est un  commentaire
% les elements de mise a jour annuelle sont indiques par
%%%% MISE A JOUR ANNUELLE
% les autres elements a mettre a jour sont indiques par
%%%% MISE A JOUR A CHAQUE FOIS
% NE PAS MODIFIER LES ESPACES NI LES SAUTS DE LIGNES

% pour saisir des caracteres accentues :
% soit on dispose d'un editeur qui le permette
% soit on travaille en 7 bits et on prefixe le caractere
%      avec \'e Ex \'el\`eve donnera eleve avec des accents
